...
def main():
    window = ti.ui.Window("Phong vs Blinn-Phong", (res_x, res_y))
    ...
    while window.running:
        ...
        with gui.sub_window("Lighting Control", 0.7, 0.05, 0.28, 0.3):
            ...
            use_blinn[None] = gui.checkbox("Use Blinn-Phong", use_blinn[None])
