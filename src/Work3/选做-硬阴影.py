        ...
        if min_t < 1e9:
            ...
            if shadow == 1:
                ...
                if use_blinn[None] == 1:
                    ...
                    spec = ti.pow(ti.max(0.0, R.dot(V)), shininess[None])
...
def main():
    ...
    while window.running:
        ...
        with gui.sub_window("Control", 0.7, 0.05, 0.28, 0.3):
